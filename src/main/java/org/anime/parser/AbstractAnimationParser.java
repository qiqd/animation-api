...
public abstract class AbstractAnimationParser implements HtmlParser, Serializable {
  @Override
  public abstract List<Animation> fetchSearchSync(String keyword, Integer page, Integer size) throws Exception;

  @Nullable
  @Override
  public abstract Detail<Animation> fetchDetailSync(String mediaId) throws Exception;
