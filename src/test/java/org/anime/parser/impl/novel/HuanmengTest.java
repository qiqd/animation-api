...
public class HuanmengTest extends TestCase {
  ...
  public void testFetchSearchSync() throws Exception {
    System.out.println(JSON.toJSONString(huanmeng.fetchSearchSync("无职转生", 1, 10)));
  }

  public void testFetchDetailSync() throws Exception {
    System.out.println(JSON.toJSONString(huanmeng.fetchDetailSync("/index.php/book/info/8655")));
  }
  ...
  public void testFetchViewSync() throws Exception {
    ...
    System.out.println(JSON.toJSONString(huanmeng.fetchViewSync("/index.php/book_read_4809_3024.html")));
  }
}